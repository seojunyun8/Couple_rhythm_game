...
namespace CoupleRhythm
{
    ...
    public sealed class SongDefinition
    {
        ...
        public float chartDelaySeconds;
        public float highlightStartSeconds;
        public float highlightEndSeconds;
        public Color accent;

        public SongDefinition(string id, string title, string artist, string resourceName, float defaultBpm, float chartDelaySeconds, float highlightStartSeconds, float highlightEndSeconds, Color accent)
        {
            this.id = id;
            this.title = title;
            this.artist = artist;
            ...
            this.chartDelaySeconds = chartDelaySeconds;
